![BiodiversityObservationNetworks](./docs/src/assets/logo_w_text.png)
...
learning](https://en.wikipedia.org/wiki/Active_learning_(machine_learning)) for model improvement, and more.
